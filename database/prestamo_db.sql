...
CREATE TABLE `detalle_compra` (
  ...
  CONSTRAINT `CONSTRAINT_2` CHECK (`precio` >= 0)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detalle_prestamo` (
  ...
  CONSTRAINT `CONSTRAINT_1` CHECK (`cantidad_prestada` >= 0),
  CONSTRAINT `CONSTRAINT_2` CHECK (`cantidad_devuelta` >= 0)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prestamo` (
  ...
  CONSTRAINT `CONSTRAINT_1` CHECK (`fecha_devolucion` = `fecha_prestamo`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-26 15:06:46
